...
class IndividualUserInvestProjectDetails extends Page
{
...
//    protected ?CompanyInvestProject $itemCompanyInvestProject = null;
    ...
    protected string $title = 'IndividualUserInvestProjectDetails';
...
//            : route('');
        ...
        $actionInvestProject = $this->hasCompanyInvestProject()
            ...
            : route('company.invest.projects.store', parameters: ['user' => auth()->user()->getAttribute('name')]);
